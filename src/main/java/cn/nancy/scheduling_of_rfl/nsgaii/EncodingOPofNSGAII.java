...
public class EncodingOPofNSGAII extends EncodingOP {    
    /**
     * 初始化
     * @param workNum 工位数量
     ...
     */
    EncodingOPofNSGAII(int workNum, Map<Integer, ArrayList<Integer>> OptStageSet, ArrayList<Integer> ProcessOfP) {
