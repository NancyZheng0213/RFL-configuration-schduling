...
if __name__ == '__main__':
    ...
    """画甘特图"""
    # %%
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\GantteData.txt", "r") as f:
        index = 1
        for line in f:
    ...
    """画散点图"""
    # %%
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\popObj.txt") as f:
        lines = f.readlines()
        line = lines[0]
    ...
    plt.legend(loc='best')
    plt.grid()
    plt.savefig("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\解散点图.png", format='png')
    ...
    """画迭代曲线图"""
    # %%
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\uOfM.txt") as f:
        lines = f.readlines()
        line = lines[0]
        utilization = json.loads(line)
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\tOfM.txt") as f:
        lines = f.readlines()
        line = lines[0]
        totaldelay = json.loads(line)
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\topuOfA.txt") as f:
        lines = f.readlines()
        line = lines[0]
        toputilization = json.loads(line)
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\bottomtOfA.txt") as f:
        lines = f.readlines()
        line = lines[0]
        bottomtotaldelay = json.loads(line)
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\bottomuOfA.txt") as f:
        lines = f.readlines()
        line = lines[0]
        bottomutilization = json.loads(line)
    with open("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\toptOfA.txt") as f:
        lines = f.readlines()
        line = lines[0]
    ...
    # plt.title('迭代曲线图')
    plt.savefig("E:\\JavaProjects\\configuration and scheduling of MRFL\\SPEA2\\sourse\\迭代曲线图.png", format='png')
    plt.show()
